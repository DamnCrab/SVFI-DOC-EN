---
title: Detailed Explanation of Advanced Content
...
### Automatically seek progress
::: tip
When the program exits due to a power outage in the middle of the task or the termination of the task due to other circumstances, you can click "**Auto Find Progress**" to restore the last block position.
:::

Before clicking this button, please click on the task entry to restore the progress. Then click "**One-key supplementary frame**", the software will pop up a window to confirm the starting position of supplementary frame.
...
### Start complement frame time and end complement frame time
...
### **ncnnCUGAN**
The NCNN version of CUGAN (A card, N card, I card common), the introduction is the same as above
...
::: warning If you are new to suppression, please keep the following rules in mind:
...
### **Interlaced Complementary Frame**
...
### Complementary frame algorithm

Select the complementary frame algorithm (including RIFE, IFRNet, DAIN, GMFSS, EMA)
